...
a persistence unit "examenRecargas_CollaguazoDaniel_JEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "examenRecargas_CollaguazoDaniel_JEE/pom.xml":
...
artifact ("examenRecargas_CollaguazoDaniel_JEE.war") is already built. You can build
